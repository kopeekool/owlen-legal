...
* **Invite Data**
  ...
  * Invite usage
  * Total messages sent for invite tracking

* **Message Data**

  * Message counts for leveling, logging, or analytics
...
* **Server (Guild) Information**
  ...
  * Server ID, roles, and channel data
  * Basic configuration settings

We do **NOT** collect sensitive personal data such as passwords, emails, or private messages outside of bot-required functionality.
...
* Provide bot features (moderation, tracking, analytics, etc.)
...
* Contact the developer via the official support server
